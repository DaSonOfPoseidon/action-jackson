      ...
      <div className="mx-auto max-w-6xl px-4 py-8 sm:px-6 lg:px-8">
        <div className="flex flex-col items-center justify-between gap-6 sm:flex-row">
          ...
          <p className="text-sm text-muted">
            Built by{" "}
            <a
              href="https://actionjacksoninstalls.com"
              target="_blank"
        ...
        {/* Bottom copyright */}
        <div className="mt-6 border-t border-white/[0.04] pt-6 text-center">
          <p className="text-xs text-muted/60">
            &copy; {new Date().getFullYear()} Jackson Keithley. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
