          ...
          <div className="flex items-center gap-2">
            {project.links.github && (
              <a
                ...
                className={`relative rounded-md p-1.5 transition-colors hover:bg-white/[0.06] ${project.isPrivate ? "text-amber-500/60 hover:text-amber-400" : "text-muted hover:text-foreground"}`}
                aria-label={`${project.title} on GitHub${project.isPrivate ? " (private repo)" : ""}`}
                title={project.isPrivate ? "Private repo" : undefined}
              >
                <svg
                  viewBox="0 0 24 24"
                  fill="currentColor"
                ...
                {project.isPrivate && (
                  <svg
                    viewBox="0 0 24 24"
                    fill="currentColor"
                    className="absolute -bottom-0.5 -right-0.5 h-2.5 w-2.5 text-amber-500"
                    aria-hidden="true"
                  >
